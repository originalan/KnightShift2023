...
@Autonomous(name = "BlueFar2 (push both pixels, park)", group = "AUTO")
public class BlueFar2 extends AutoBase {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        startingPose = new Pose2d(-36, 63.125, Math.toRadians(270));
        PoseStorage.startingAutoPose = new Pose2d(-36, 63.125, Math.toRadians(270)); // to prevent shadowing
        ...
        telemetry.addLine("Blue, starting farther to backstage");
