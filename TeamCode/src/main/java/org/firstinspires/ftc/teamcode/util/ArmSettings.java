...
public class ArmSettings {
    ...
    public static double CLAW_RIGHT_CLOSE = 0.27;
    public static double CLAW_RIGHT_OPEN = 0;
    public static double CLAW_LEFT_CLOSE = 0.27;
    ...
    public static int position1 = 475;
    public static int position2 = 540;
    public static int position3 = 570;
    public static int positionYellowPixel = 590;
